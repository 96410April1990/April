...
public class SampleScriptFour {
	...
	@BeforeTest
	public void readExcelOne() throws IOException, InterruptedException {
		
		try {
			FileInputStream fis = new FileInputStream(new File("C://Users//NANDAKUMARSIR//workspace//April//Excel Sheets//youtube_searchone.xlsx"));
	...
	@Test
	public void accessYoutubeOne() throws IOException, InterruptedException, WebDriverException {
		...
		try {
			...
			driver.findElementByXPath("/html/body/div[2]/div[2]/div[2]/div/div[3]/form/div/input").sendKeys("Narendra Modi");
	...
	public void writeExcelOne() throws IOException {
		...
		FileOutputStream fos = new FileOutputStream(new File("C://Users//NANDAKUMARSIR//workspace//April//Excel Sheets//tc_two.xlsx"));
